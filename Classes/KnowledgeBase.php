...
class KnowledgeBase implements \t3lib_Singleton {
	...
	public function authenticate($username = 'Anonymous', $password = '') {
		...
		$adapter = $this->objectManager->create('T3\Semantic\Authentication\Adapter\Typo3', $username, $password);
	...
	public function getAccessControl() {
		if (NULL === $this->accessControl) {
			$this->accessControl = $this->objectManager->create('\T3\Semantic\AccessControl\Standard');
		}
	...
	public function getAuthentication() {
		if (NULL === $this->authentication) {
			...
			if (isset($this->getSessionConfiguration()->identifier)) {
				$sessionNamespace = 'Semantic_Authentication' . $this->getSessionConfiguration()->identifier;
				$auth->setStorage($this->objectManager->create('\T3\Semantic\Authentication\Storage\Session', $sessionNamespace));
			}
	...
	public function getLog($logIdentifier = 'erfurt') {
		return $this->objectManager->get('\T3\Semantic\Log\NullLogger');
	}
	...
	public function getVersioning() {
		if (NULL === $this->versioning) {
			$this->versioning = $this->objectManager->create('\T3\Semantic\Versioning\Versioning');
		}
