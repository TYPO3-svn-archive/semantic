...
class RdfSerializer {
	...
	public function initializeWithFormat($format) {
		...
		switch ($format) {
			case 'rdfxml':
				$this->serializerAdapter = $this->objectManager->create('\T3\Semantic\Syntax\RdfSerializer\Adapter\RdfXml');
				break;
			case 'turtle':
			case 'rdfn3':
				$this->serializerAdapter = $this->objectManager->create('\T3\Semantic\Syntax\RdfSerializer\Adapter\Turtle');
				break;
			case 'rdfjson':
				$this->serializerAdapter = $this->objectManager->create('\T3\Semantic\Syntax\RdfSerializer\Adapter\RdfJson');
				break;
			default:
